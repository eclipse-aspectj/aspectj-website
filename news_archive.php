  ...
  <div id="main">
    ...
    <dl>
      ...
      <dd>The AspectJ 5 milestone 5 build was released today. It contains a large number of bug fixes and
        ...
        <a href="downloads.php">downloads page</a>. You can see the list of remaining bugs to fix before 1.5.0 is
        finished
      ...
      <dd>Russ Miles has made available the 0.1 release of <a href="http://www.aunit.org">aUnit</a>, a
        ...
        with a set of examples in the source download to show you how to create tests.
      </dd>
