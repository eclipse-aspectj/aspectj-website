...
<table BORDER="0" CELLSPACING="5" CELLPADDING="2" WIDTH="100%">
  ...
  <tr>
    <td>
      <table style="BORDER-COLLAPSE: collapse" borderColor="#111111" cellSpacing="0" cellPadding="3" width="100%"
             border="0">
        <tr>
        ...
        <tr>
          <td colSpan="3"><br><i>This download is updated after
              every successful build and test cycle. Please select the 'main eclipse.org downloads area' when presented
              with a list of mirrors
