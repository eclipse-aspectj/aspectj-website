      ...
      <div class="homeitem" style="width: 97%">
        ...
        <ul>
          <p>The <a href="doc/released/adk15notebook/index.html">AspectJ 5 Developer's Notebook</a>
            ...
            yet reflected in the programming guide.
          </p>
        </ul>
      </div>
      ...
      <div class="homeitem" style="width: 97%">
        ...
        <ul>
          ...
          <li>
            ...
            <p>The <a href="doc/released/pdguide/index.html"/>AspectJ problem diagnosis</a> guide describes the
              tracing/logging and dump framework.</p>
            <p>
